...
async function loadD(){ return; }
function saveDCache(){}
function loadDCache(){ dDefaults(); }
function startRealtimeSync(){}
async function resetD(){ toast('Reset disabled in demo mode','info'); }
...
function loadDemoData(){
  ...
  const transitions = [
    {id:'tr01',role:'President',outgoing:'m01',incoming:'m02',status:'in_progress',
     ...
     contacts:[{name:'Dr. Sarah Kim',role:'Greek Life Advisor',email:'skim@university.edu',phone:'555-0101'},{name:'ATO Field Officer',role:'ATO National',email:'fieldofficer@ato.org',phone:'555-0199'}]},
    {id:'tr02',role:'Vice President',outgoing:'m02',incoming:'m05',status:'in_progress',
     ...
     contacts:[{name:'IFC VP',role:'IFC Executive',email:'ifc@university.edu',phone:'555-0102'}]},
    {id:'tr03',role:'Treasurer',outgoing:'m03',incoming:null,status:'not_started',
     content:'',wishIKnew:'',contacts:[]},
    {id:'tr04',role:'Secretary',outgoing:'m04',incoming:null,status:'not_started',
     content:'',wishIKnew:'',contacts:[]},
    {id:'tr05',role:'Recruitment Chair',outgoing:'m05',incoming:null,status:'review',
     ...
     contacts:[{name:'IFC Recruitment',role:'IFC',email:'recruitment@ifc.edu',phone:'555-0103'}]},
    {id:'tr06',role:'Risk Manager',outgoing:'m06',incoming:null,status:'not_started',
     content:'',wishIKnew:'',contacts:[]},
    {id:'tr07',role:'Philanthropy Chair',outgoing:'m08',incoming:null,status:'complete',
    ...
    {id:'tr08',role:'Scholarship Chair',outgoing:'m07',incoming:null,status:'not_started',
     content:'',wishIKnew:'',contacts:[]},
  ];
  ...
  D = {
    ...
    finance: {
      dues, fines, expenses, plans: [], payments: [], nationalDues: {}, nationalPayments: [],
